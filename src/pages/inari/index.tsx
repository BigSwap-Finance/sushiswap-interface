      ...
      <Container maxWidth="5xl" className="flex flex-col gap-8 px-4 py-8">
        <div className="flex items-center gap-8">
          <div className="min-w-[140px] min-h-[105px]">
            <Image src="/public/logo.png" alt="" width={140} height={105} />
          </div>
          <div className="flex flex-col">
            ...
            <Typography>
              {i18n._(t`Take your BGSP and invest in various strategies with one click! Earn extra yields with Big Bank, use as
