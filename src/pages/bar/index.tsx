    ...
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        ...
        <meta
          key="description"
          name="description"
          content="Stake BGSP in return for xBGSP, an interest bearing and fungible ERC20 token designed to share revenue generated by all Big Swap products."
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.sushi.com/stake" />
        <meta key="twitter:title" name="twitter:title" content="STAKE BGSP" />
        <meta
        ...
        <meta key="og:title" property="og:title" content="STAKE BGSP" />
      ...
      <div className="flex flex-col w-full min-h-full">
        <div className="flex justify-center mb-6">
          <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
            ...
            <div className="max-w-lg pr-3 mb-2 text-sm leading-5 text-white-500 md:text-base md:mb-4 md:pr-0">
              {i18n._(t`For every swap on the exchange on every chain, 0.05% of the swap fees are distributed as BGSP
                                proportional to your share of the BigBar. When your BGSP is staked into the BigBar, you receive
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center ml-8 space-x-4 md:ml-0">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">BGSP</p>
                    </div>
                  </div>
                </div>
